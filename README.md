...
<!-- AUTO:PUBLIC:BEGIN (generated by update-index.ps1 from audits.json; do not edit by hand) -->
- [**1001 Squares of NFT**](./clients/1001-squares-of-nft/)
- [**1Gogh**](./clients/1gogh/)
- [**1walletwins**](./clients/1walletwins/)
- [**5ire**](./clients/5ire/)
...
- [**Primus Labs**](./clients/primus-labs/)
- [**Prophet Markets**](./clients/prophet-markets/)
...
- [**Silencio**](./clients/silencio/)
- [**Sogni**](./clients/sogni/)
- [**Space and Time**](./clients/space-and-time/)
- [**SushiSwap**](./clients/sushi-swap/)
...
📋 **Audits Directory:** [hashlock.com/audits](https://hashlock.com/audits)
🤖 **Free AI Audit Tool:** [aiaudit.hashlock.com](https://aiaudit.hashlock.com)
📩 **Request an Audit:** [Submit our RFI form](https://hashlock.com/new-client-request-for-information)
...
_All audit reports in this repository are published with client consent. Hashlock retains ownership of report content per our standard engagement terms. For full disclaimers, methodology, and severity definitions, please refer to each individual audit report PDF._
