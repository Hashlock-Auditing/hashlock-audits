# Posse Studios (DreamBay): Hashlock Security Audit

**Client:** Posse Studios (DreamBay)
...
🔗 **Project Websites:** [dreambay.io](https://dreambay.io), [possestudios.io](https://possestudios.io)
🔗 **Hashlock Audit Page:** [hashlock.com/audits/posse-studios](https://hashlock.com/audits/posse-studios)

> **Note on naming:** This audit is published under **Posse Studios**, the parent studio. The audited product is **DreamBay**, a Posse Studios subsidiary. If you are looking for the DreamBay audit, this is it.

## About Posse Studios and DreamBay

Posse Studios is a development studio building blockchain and gaming technology. DreamBay, a Posse Studios subsidiary, is a next generation digital asset marketplace powered by AI, where users create 3D assets with generative tools, buy and sell tokenized goods, and earn rewards through gamified experiences. The audited contracts implement an onchain token launchpad: a factory deploys new ERC20 tokens with associated bonding curves, and trading transitions to Uniswap V2 once a curve completes, with initial LP tokens burned to lock liquidity.
...
📄 [Read the full audit report (PDF)](./DreamBay-Smart-Contract-Audit-Report-Final-Report-v3.pdf)

🌐 [View on hashlock.com](https://hashlock.com/audits/posse-studios)
