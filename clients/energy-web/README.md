...
|---|-----------|-------------|
| 1 | `parachain-staking` pallet | Nominator/collator lifecycle, era transitions, rewards |
...
> **Multiple Engagements:** Hashlock has conducted three separate audits across the Energy Web ecosystem: the core parachain (bridge + staking), the EWX integration with Polkadot Asset Hub, and the liquid staking pallet.
...
**Substrate & Polkadot Expertise:** Hashlock has deep experience auditing Substrate-based chains, custom pallets, runtime upgrades, and cross-chain (XCM) integrations across the Polkadot and Kusama ecosystems.
