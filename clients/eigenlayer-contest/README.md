...
**Engagement Type:** Security Competition Participation (Cantina)
**Project Type:** Restaking & AVS Infrastructure
**Network:** Ethereum
**Language:** Solidity
**Report Type:** Final Submission v2
**Security Rating:** ✅ **Audited**

🔗 **Project Website:** [eigenlayer.xyz](https://www.eigenlayer.xyz/)
🔗 **Hashlock Audit Page:** [hashlock.com/audits/eigenlayer-contest](https://hashlock.com/audits/eigenlayer-contest)
...
EigenLayer hosted a security competition on **Cantina** in March 2025, covering major changes being made to the **core restaking protocol**. These changes included significant updates to most system contracts and introduced new contracts to manage slashing and slashable stake allocation.
...
- Provide market validation through public leaderboards and severity rankings
- Have been adopted by leading protocols including EigenLayer, Aave, Optimism, and Spark

Hashlock's auditors actively participate in these competitions to keep our methodology sharp and our team competitive at the highest level of Web3 security research.

## Full Engagement Details

📄 [Read Hashlock's competition submission (PDF)](./EigenLayer-Competition-Submission-v2.pdf)

🌐 [View on hashlock.com](https://hashlock.com/audits/eigenlayer-contest)
📊 [View Cantina competition](https://cantina.xyz/)
...
_Hashlock's competition participation is publicly disclosed and documented on Cantina's platform._
