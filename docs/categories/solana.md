# Hashlock Solana Audit Portfolio

> Smart contract security audits for Solana programs and Anchor based protocols, including Rust based DeFi, infrastructure, and gaming projects across the Solana ecosystem.
